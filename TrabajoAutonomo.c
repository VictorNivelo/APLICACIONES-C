...
/*Trabajo Autonomo
Una financiera que se dedica a realizar créditos a pesonas desea un programa que le ayude a
generar y calcular las tablas de amortización e imprimir las mismas hacia su cliente, para lo
cual se tiene el siguiente modelo e historia de usuario respectiva:
...
void presentarNumeroAleatorio()
{
    char *numeroAleatorioTabla[mesPlazo];
    srand(time(NULL));
